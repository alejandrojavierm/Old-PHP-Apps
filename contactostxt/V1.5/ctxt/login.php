...
?>
<title>Contacto TXT v1.0a - &copy; Nova Networks - Alejandro Moyano ::.</title>
...
<div align="center">
  ...
  <table width="232" border="0">
    <tr>
      <td width="220"><img src="imagenes/contactotxt.jpg" width="261" height="81" /></td>
    </tr>
  </table>
<?php
...
<form action="<? echo $_SERVER['PHP_SELF'];?>" method="post" name="adminlogin" id="adminlogin" style="display:inline;">
  <table width="233" border="0" align="center">
    ...
    <tr>
      <td colspan="2"><div align="center"><a href="http://www.nova-networks.com.ar" class="Estilo29">Nova Networks</a></div></td>
    </tr>
  </table>
</form>
  <p>&nbsp;</p>
...
<table width="672" border="0" align="center">
  ...
  <tr>
    <td><span class="Estilo1">Contacto TXT  - Panel de control</span></td>
  </tr>
  <tr>
    <td><span class="Estilo27"> &copy; Nova Networks - Alejandro Moyano </span></td>
  </tr>
  <tr>
