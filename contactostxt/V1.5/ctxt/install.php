      ...
      <td background="imagenes/bg04.GIF"><div align="center">
        <form action="proceso.php" method="post">
          <table width="657" border="0">
            ...
            <tr>
              <td width="126"><? echo $lang[9];?></td>
              <td width="521" colspan="2"><input name="usuario" type="text" id="usuario" value="usuario" /></td>
            </tr>
            <tr>
              <td><? echo $lang[10];?></td>
            ...
            <tr>
              <td height="32"><? echo $lang[24];?> </td>
              <td colspan="2"><table width="497" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="414"><font size="2"><em><? echo $lang[17];?></em></font>
            ...
            <tr>
              <td><? echo $lang[15];?></td>
              <td colspan="2"><input name="titulo" type="text" id="titulo" size="40" /></td>
            </tr>
            <tr>
              <td><? echo $lang[25];?></td>
              <td colspan="2"><label>
                <select name="borde" id="borde">
                  <option value="1"><? echo $lang[12];?></option>
                  <option value="2"><? echo $lang[13];?></option>
                </select>
              </label></td>
            </tr>
            <tr>
              <td><? echo $lang[26];?></td>
              <td colspan="2"><? echo $lang[27];?></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan="2">&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td colspan="2"><input type="submit" name="Submit" value="<? echo $lang[22];?>" /></td>
            </tr>
            <tr>
              <td colspan="3">&nbsp;</td>
            </tr>
